...
const STATUS_COLORS: Record<string, string> = {
  'Live Platform': '#0D8A72',
  'In Development': '#1B6F2E',
  'Research & Development': '#7B4A0E',
...
const PROJECTS = [
  {
    ...
    desc: "HarborTwin is Uminato Maritime's modular technology platform for the port and terminal value chain. It brings together pre-built capabilities, proven technology components, specialist startups, and OEM partner solutions.",
    ...
    <section className="py-28 md:py-36 border-t border-bd-subtle" style={{ background: '#080F1E' }}>
      <div className="max-w-[1220px] mx-auto px-8 md:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          ...
          <Link
            href="/projects"
            className="inline-flex items-center gap-2 font-body font-medium text-sky-base border border-sky-base rounded-md transition-all min-h-[44px] justify-center hover:bg-sky-base/10"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {PROJECTS.map((proj) => {
            ...
            return (
              <div
                key={proj.id}
                className="group relative flex flex-col rounded-xl border border-bd-subtle transition-all duration-500 overflow-hidden shadow-lg hover:border-sky-base/40"
                style={{ background: '#0F1E38' }}
              >
                {/* Image Background Header with Gradient Overlay */}
                ...
                <div className="flex flex-col flex-1 p-8 pt-2">
                  ...
                  <p
                    ...
                    style={{ fontSize: '0.78rem', color: '#4AB8E8', opacity: 0.85 }}
                  >
                    {proj.subtitle}
                  </p>
