      ...
      <div className="w-full h-full flex items-center justify-center max-w-[1220px] mx-auto px-7 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 w-full mt-16">
          <div className="bg-bg-base/40 backdrop-blur-sm p-6 rounded-2xl border border-bd-subtle/50">
            <h2 className="font-display text-[26px] font-bold text-t1 mb-6">Projects</h2>
          ...
          <div className="flex flex-col gap-16">
            <div id="podcast" className="bg-bg-surface/60 backdrop-blur-md border border-bd-subtle rounded-[14px] p-8 hover:border-bd-default transition-colors">
              <h2 className="font-display text-[26px] font-bold text-t1 mb-2">The UMINATO Podcast</h2>
              ...
              <button className="bg-sky-base hover:bg-sky-light text-t-inv font-medium py-[11px] px-[22px] rounded-md transition-all shadow-[0_0_28px_rgba(74,184,232,0.22)]">
                Subscribe
              </button>
            </div>
            ...
            <div id="blog" className="bg-bg-surface/60 backdrop-blur-md border border-bd-subtle rounded-[14px] p-8 hover:border-bd-default transition-colors">
              <h2 className="font-display text-[26px] font-bold text-t1 mb-6">Blogs</h2>
              <div className="mb-6">
              ...
              <button className="bg-transparent border border-sky-base text-sky-base hover:bg-sky-base/10 font-medium py-[11px] px-[22px] rounded-md transition-all">
                View All Insights
              </button>
            </div>
          </div>
