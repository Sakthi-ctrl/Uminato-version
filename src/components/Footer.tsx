...
const RssIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 11a9 9 0 0 1 9 9"/><path d="M4 4a16 16 0 0 1 16 16"/><circle cx="5" cy="19" r="1"/></svg>;
          ...
          <>
            <div className="flex flex-col items-center text-center mb-20">
              ...
              <div className="flex items-center justify-center gap-4">
                <span className="text-[12px] font-semibold tracking-[0.1em] text-t3 uppercase mr-2">Follow UMINATO:</span>
                ...
                <a href="#" aria-label="Spotify" className="w-9 h-9 bg-bg-card border border-bd-default rounded-md flex items-center justify-center text-t2 hover:bg-bg-raised hover:text-sky-base hover:border-sky-base transition-all"><RssIcon /></a>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8">
          <div className="md:col-span-5 lg:col-span-4">
            ...
            <div className="flex gap-2">
              ...
              <span className="text-[10px] uppercase font-semibold text-t3 border border-bd-subtle px-2.5 py-1.5 rounded bg-bg-surface">Scale</span>
            </div>
          </div>
          
          <div className="md:col-span-7 lg:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-8 text-[13px]">
            ...
            <div className="flex flex-col gap-4">
              <h4 className="text-[11px] font-bold text-t1 uppercase tracking-widest mb-2">Insights</h4>
            ...
            <div className="flex flex-col gap-4">
              <h4 className="text-[11px] font-bold text-t1 uppercase tracking-widest mb-2">Connect</h4>
              <Link href="/contact" className="text-t2 hover:text-sky-base transition-colors">Contact Us</Link>
              <a href="#" className="text-t2 hover:text-sky-base transition-colors mt-2 text-sky-base flex items-center gap-2 font-medium">
