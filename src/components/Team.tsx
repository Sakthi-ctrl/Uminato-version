  ...
  return (
    <section id="team" className="py-24 bg-bg-deep relative z-30">
      <div className="max-w-[1220px] mx-auto px-7">
        ...
        <h2 className="font-display text-3xl font-bold text-t1 mb-16 text-center">Team &amp; Partners</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="bg-bg-card border border-bd-subtle rounded-2xl p-8 hover:border-bd-default transition-all hover:-translate-y-1">
            ...
            <a href="#" className="text-sky-base text-[13px] font-medium hover:text-sky-light inline-flex items-center gap-2">View Profiles &rarr;</a>
          </div>
          ...
          <div className="bg-bg-card border border-bd-subtle rounded-2xl p-8 hover:border-bd-default transition-all hover:-translate-y-1">
            ...
            <a href="#" className="text-sky-base text-[13px] font-medium hover:text-sky-light inline-flex items-center gap-2">View Partners &rarr;</a>
          </div>
        </div>
      </div>
    </section>
